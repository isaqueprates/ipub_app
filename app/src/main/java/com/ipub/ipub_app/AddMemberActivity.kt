...
class AddMemberActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Ipub_appTheme {
                AddMemberScreen(
                    onSave = { name, role, department, birthday, dateBatism, dateEspirit ->
                        viewModel.insert(name, role, department, birthday, dateBatism, dateEspirit) { success, message ->
                            Toast.makeText(
                                this,
...
fun AddMemberScreen(
    ...
    var dateBatism by remember { mutableStateOf("") }
    var dateEspirit by remember { mutableStateOf("") }
    ...
    // 🔹 NOVO DatePicker Batismo nas Águas
    val datePickerBatism = DatePickerDialog(
        context,
        { _, y, m, d ->
    ...
    // 🔹 NOVO DatePicker Batismo no Espírito
    val datePickerEspirit = DatePickerDialog(
        context,
        { _, y, m, d ->
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = {},
                readOnly = true,
                label = { Text("Batismo nas Águas (DD/MM/AAAA)") },
                trailingIcon = {
                    IconButton(onClick = { datePickerBatism.show() }) { // 🔹 Mostra o DatePicker
                        Icon(Icons.Default.DateRange, contentDescription = null)
                    }
                },
                modifier = Modifier.fillMaxWidth(),
            ...
            OutlinedTextField(
                ...
                onValueChange = {},
                readOnly = true,
                label = { Text("Batismo no Espírito (DD/MM/AAAA)") },
                trailingIcon = {
                    IconButton(onClick = { datePickerEspirit.show() }) { // 🔹 Mostra o DatePicker
                        Icon(Icons.Default.DateRange, contentDescription = null)
                    }
                },
                modifier = Modifier.fillMaxWidth(),
